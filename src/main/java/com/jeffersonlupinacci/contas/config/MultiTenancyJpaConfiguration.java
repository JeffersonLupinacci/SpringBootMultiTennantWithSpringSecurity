...
import com.jeffersonlupinacci.contas.model.saas.Categoria;
...
public class MultiTenancyJpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder builder) {
		...
		return builder.dataSource(dataSource).packages(Usuario.class.getPackage().getName(),
				Contrato.class.getPackage().getName(), Categoria.class.getPackage().getName()
